...
bool PatternDatabase::setNumMoves(const GenericRubicksCube &cube, const uint8_t numMoves) {
...
uint8_t PatternDatabase::getNumMoves(const GenericRubicksCube &cube) const {
